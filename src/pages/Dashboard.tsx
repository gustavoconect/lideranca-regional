                    ...
                    <div className="flex h-full flex-col gap-2 p-6">
                        <div className="flex items-center gap-2 px-2 pb-8">
                            ...
                            <div className="flex flex-col">
                                <span className="text-lg font-black tracking-tighter text-slate-900 border-none leading-none">REGIONAL<span className="text-emerald-500">APP</span></span>
                ...
                <header className={`sticky top-0 z-30 flex h-20 items-center gap-4 px-4 md:px-8 border-b transition-all duration-700 ${presentationMode ? 'bg-slate-950/80 border-slate-800 text-white backdrop-blur-xl' : 'bg-white/80 border-slate-100 backdrop-blur-md'}`}>
                    <div className="flex flex-col">
                        <h1 className="text-xl font-black tracking-tight md:text-2xl uppercase italic">
                            {presentationMode ? 'Center of Strategic Intelligence' : 'Dashboard Executivo'}
                        </h1>
                ...
                <main className={`flex flex-1 flex-col gap-8 p-4 md:gap-10 md:p-10 transition-colors duration-700 ${presentationMode ? 'bg-[#020617]' : ''}`}>
                    ...
                    <div className="grid gap-8 lg:grid-cols-3">
                        <motion.div
                            ...
                            className={`lg:col-span-2 rounded-[2rem] overflow-hidden shadow-2xl ring-1 ${presentationMode ? 'bg-slate-900/40 ring-white/5 p-1' : 'bg-white ring-slate-200/60 p-1'}`}
                        >
                            <div className="p-2">
                            ...
                            {!presentationMode ? (
                                ...
                                >
                                    ...
                                    <div className="space-y-6 relative z-10">
                                        ...
                                        <Button
                                            variant="outline"
                                            className="w-full h-11 border-slate-700 bg-slate-800/50 text-slate-300 hover:bg-slate-800 hover:text-white rounded-xl uppercase text-[10px] font-black tracking-widest mt-6"
                                            onClick={() => navigate('/reports')}
                                        >
                                            Ver Dossiê Investigativo
                                        </Button>
                                    </div>
                                </motion.div>
                            )}
